...
const Home = () => {
  ...
  return (
    <main className='min-h-screen bg-black p-8 px-16'>
      <div className='flex items-center justify-between mb-10'>
        ...
        <button
          ...
          className='flex items-center justify-center h-10 bg-[#DAE100] p-6 text-xl font-bold text-black transition-all hover:bg-[#E5E900]'
        >
          <span>DEMO</span>
        </button>
      </div>
